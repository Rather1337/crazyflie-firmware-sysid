...
if __name__ == "__main__":
    ...
    if args.file != "":
        ...
        files = [
            ...
            # f"data/data_{mode}_{comb}_M2_00.csv",
            # f"data/data_{mode}_{comb}_M2_01.csv",
            # f"data/data_{mode}_{comb}_M2_02.csv",
            # f"data/data_{mode}_{comb}_M3_00.csv",
            # f"data/data_{mode}_{comb}_M3_01.csv",
            # f"data/data_{mode}_{comb}_M3_02.csv",
            # f"data/data_{mode}_{comb}_M4_00.csv",
        ...
        filesVal = [
            ...
            # f"data/data_{mode}_{combVal}_M4_02.csv",
            # f"data/data_{mode}_{combVal}_M4_old_00.csv",
        ]
